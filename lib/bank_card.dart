              ...
              children: <Widget>[
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Text(
                        ...
                        textAlign: TextAlign.left,
                        style: TextStyle(
                            color: card.bgAsset == 'bg_blue_circle_card.png' || card.bgAsset == 'bg_blue_circle_card.png' ? Colors.grey : Colors.black,
                            fontSize: 10.0,
                            fontWeight: FontWeight.bold),
                      ),
                      Padding(
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    textAlign: TextAlign.left,
                    style: TextStyle(
                        color: card.bgAsset == 'bg_blue_circle_card.png' || card.bgAsset == 'bg_blue_circle_card.png' ? Colors.grey : Color(0xFF253C70),
                        fontSize: 12.0,
                        fontWeight: FontWeight.bold),
                  ),
                ),
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Text(
                            ...
                            textAlign: TextAlign.left,
                            style: TextStyle(
                                color: card.bgAsset == 'bg_blue_circle_card.png' || card.bgAsset == 'ibg_blue_circle_card.png' ? Colors.grey : Color(0xFF253C70),
